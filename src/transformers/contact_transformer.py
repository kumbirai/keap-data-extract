    ...
    def transform(data: dict, db: Session) -> Contact:
        ...
        if 'addresses' in data:
            ...
            for addr_data in data['addresses']:
                address = Address(id=addr_data['id'],
        ...
        if 'email_addresses' in data:
            ...
            for email_data in data['email_addresses']:
                email = EmailAddress(id=email_data['id'],
        ...
        if 'phone_numbers' in data:
            ...
            for phone_data in data['phone_numbers']:
                phone = PhoneNumber(id=phone_data['id'],
                                    number=phone_data.get('number'),
                                    field=phone_data.get('field'))
                db.add(phone)
        ...
        if 'fax_numbers' in data:
            ...
            for fax_data in data['fax_numbers']:
                fax = FaxNumber(id=fax_data['id'],
                                number=fax_data.get('number'),
                                field=fax_data.get('field'))
                db.add(fax)
        ...
        if 'custom_fields' in data:
            ...
            for field_data in data['custom_fields']:
                custom_value = ContactCustomFieldValue(id=field_data['id'],
        ...
        if 'opportunities' in data:
            ...
            for opp_data in data['opportunities']:
                opportunity = Opportunity(id=opp_data['id'],
        ...
        if 'subscriptions' in data:
            ...
            for sub_data in data['subscriptions']:
                subscription = Subscription(id=sub_data['id'],
                                            status=sub_data.get('status'),
                                            next_bill_date=sub_data.get('next_bill_date'))
                db.add(subscription)
