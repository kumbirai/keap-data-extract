...
from src.scripts.load_data import (
    load_contact_by_id, load_product_by_id, load_affiliate_by_id,
    load_order_by_id, load_opportunity_by_id, load_task_by_id,
    load_note_by_id, load_campaign_by_id
)
...
class ErrorReprocessor:
    ...
    def __init__(self):
        ...
        self.load_functions = {
            'contacts': load_contact_by_id,
            'products': load_product_by_id,
            'affiliates': load_affiliate_by_id,
            'orders': load_order_by_id,
            'opportunities': load_opportunity_by_id,
            'tasks': load_task_by_id,
            'notes': load_note_by_id,
            'campaigns': load_campaign_by_id,
        }
        
        # Custom load functions for entities that don't have individual ID loaders
        self.custom_load_functions = {
            'subscriptions': self.load_subscription_by_id,
        }
