...
class KeapClient(KeapBaseClient):
    ...
    def get_opportunities(self, contact_id: Optional[int] = None, limit: int = 50, offset: int = 0) -> List[Opportunity]:
    ...
    def get_subscriptions(self, contact_id: Optional[int] = None, limit: int = 50, offset: int = 0) -> List[Subscription]:
