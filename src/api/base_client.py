...
class KeapBaseClient:
    ...
    def _handle_response(self, response: requests.Response) -> Dict:
        ...
        quota_headers = {'x-keap-product-quota-limit': response.headers.get('x-keap-product-quota-limit'), 'x-keap-product-quota-time-unit': response.headers.get('x-keap-product-quota-time-unit'),
            'x-keap-product-quota-interval': response.headers.get('x-keap-product-quota-interval'), 'x-keap-product-quota-available': response.headers.get('x-keap-product-quota-available'),
            'x-keap-product-quota-used': response.headers.get('x-keap-product-quota-used'), 'x-keap-product-quota-expiry-time': response.headers.get('x-keap-product-quota-expiry-time')}
        ...
        throttle_headers = {'x-keap-product-throttle-limit': response.headers.get('x-keap-product-throttle-limit'),
            ...
            'x-keap-product-throttle-available': response.headers.get('x-keap-product-throttle-available'), 'x-keap-product-throttle-used': response.headers.get('x-keap-product-throttle-used')}
        ...
        tenant_headers = {'x-keap-tenant-id': response.headers.get('x-keap-tenant-id'), 'x-keap-tenant-throttle-limit': response.headers.get('x-keap-tenant-throttle-limit'),
            'x-keap-tenant-throttle-time-unit': response.headers.get('x-keap-tenant-throttle-time-unit'), 'x-keap-tenant-throttle-interval': response.headers.get('x-keap-tenant-throttle-interval'),
            'x-keap-tenant-throttle-available': response.headers.get('x-keap-tenant-throttle-available'), 'x-keap-tenant-throttle-used': response.headers.get('x-keap-tenant-throttle-used')}
